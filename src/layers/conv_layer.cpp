...
// void vnni_conv_common_jit<4, 1, 0>(const uint8_t* frame, const int8_t* kernel, int32_t* res, int in1, int in2, int _k1);
// void vnni_conv_common_jit<5, 1, 1>(const uint8_t* frame, const int8_t* kernel, int32_t* res, int in1, int in2, int _k1);
// void vnni_conv_common_jit<6, 1, 2>(const uint8_t* frame, const int8_t* kernel, int32_t* res, int in1, int in2, int _k1);
// void vnni_conv_common_jit<7, 1, 3>(const uint8_t* frame, const int8_t* kernel, int32_t* res, int in1, int in2, int _k1);
// void vnni_conv_common_jit<8, 2, 0>(const uint8_t* frame, const int8_t* kernel, int32_t* res, int in1, int in2, int _k1);
...
template class Convolution2d<float, float>;
// template class Convolution2d<double, double>;
// template class Convolution2d<float, double>;
// template class Convolution2d<double, float>;

// template<typename InType, typename OutType> class Convolution2d<double, double>;


template<typename InType, typename OutType>
Convolution2d<InType, OutType>::Convolution2d(Parameter par, Initializer<InType> initWeigts, Initializer<InType> initBiases):
...
template<typename InType, typename OutType>
void Convolution2d<InType, OutType>::forward(const Tensor<InType>& data) {
...
template<typename InType, typename OutType>
void Convolution2d<InType, OutType>::backward(const Tensor<InType>& grad, bool compute_grad) {
...
template<typename InType, typename OutType>
void Convolution2d<InType, OutType>::computeWeightsDerivatives(size_t batchSize, const Tensor<InType>& grad) {
